<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="LoginCliente.aspx.cs" Inherits="BancoWeb.LoginCliente" %>
<!DOCTYPE html>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Inicio sesión para clientes </title>
        ...
        <form id="form1" runat="server">
            <div class="row">
                <div class="col-4 mx-auto mt-8 mb-8 rounded shadow-lg" style="background:#8D97AA">
                    <h1 class="text-center" style="color:#22417A  ">Iniciar Sesión Clientes</h1>
                    <hr />
